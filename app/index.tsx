  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <Text>
        ...
        assist young people with information of career paths that are available
        in the financial sector. This portal also serves as a platform for
        learners to join a database and for training providers and employers to
        access information on potential learners seeking to join education and
        training in the financial sector and / or seek placement.
      </Text>
      <Text>
